...
<div class="relative w-full h-80" id="home">
    ...
    <div class="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
        <div class="md:w-1/2 mb-4 md:mb-0">
            <h1 class="text-grey-700 font-medium text-3xl md:text-4xl leading-tight mb-2">Informasi Magang Dinas Tenaga Kerja dan<br>Transmigrasi Provinsi Jawa Timur</h1>
