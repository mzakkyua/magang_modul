...
document.addEventListener("DOMContentLoaded", function() {
    ...
    console.log("✅ Assessment Logic Loaded!");
    ...
    function calculateAverage() {
        ...
        container.classList.remove('bg-blue-600', 'bg-green-600', 'bg-yellow-500', 'bg-red-600');
        
        // Set warna baru
        if (avg >= 85) container.classList.add('bg-green-600');      // A (Sangat Baik)
        else if (avg >= 70) container.classList.add('bg-blue-600');  // B (Baik)
        else if (avg >= 50) container.classList.add('bg-yellow-500');// C (Cukup)
