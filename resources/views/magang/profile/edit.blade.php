    ...
    <div class="max-w-6xl mx-auto py-12 px-4">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
            ...
            <div class="flex items-center gap-3 bg-white p-3 rounded-2xl shadow-md border border-gray-100">
                <div
                    class="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-blue-200">
        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data"
                ...
                <div class="bg-white shadow-xl shadow-gray-200/50 border border-gray-100 rounded-[2.5rem] p-8 md:p-10">
                    ...
                    <div class="grid md:grid-cols-2 gap-x-6 gap-y-6">
                        ...
                        @foreach ($fields as $index => $field)
                            <div class="{{ $field['span'] ?? '' }} space-y-2">
                                <label
                                    class="text-[11px] font-black uppercase tracking-0.1em text-[#37517e] ml-1">{{ $field['label'] }}</label>
                            ...
                            @if ($index == 2)
                                <div class="space-y-2">
                                    <label
                                        class="text-[11px] font-black uppercase tracking-0.1em text-[#37517e] ml-1">Jenjang
                                        Pendidikan</label>
                                    <div class="relative">
                                        ...
                                        <i
                                            class="bi bi-chevron-down absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"></i>
                                    </div>
                                </div>
                            @endif
                        @endforeach
                        ...
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-[11px] font-black uppercase tracking-0.1em text-[#37517e] ml-1">Alamat
                                Lengkap</label>
                    ...
                    <div class="mt-8 border-t border-gray-100 pt-8">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <h2 class="text-xl font-bold text-[#37517e]">Dokumen Lampiran (Format PDF)</h2>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label
                                    class="text-[11px] font-black uppercase tracking-0.1em text-[#37517e] ml-1">Curriculum
                                    Vitae (CV) <span class="text-red-500">*Maks 2MB</span></label>
                                <input type="file" name="cv_file" accept=".pdf"
                                    class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl px-5 py-3 text-sm focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none font-bold text-gray-800 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">

                                {{-- Indikator file sudah ada --}}
                                @if ($profile->cv_file_path)
                                    <p class="text-xs text-emerald-600 font-bold ml-1 mt-2">
                                        <i class="bi bi-check-circle-fill mr-1"></i> File CV sudah tersimpan.
                                    </p>
                                @endif
                            </div>
                            ...
                            {{-- Input Proposal --}}
                            <div class="space-y-2">
                                <label class="text-[11px] font-black uppercase tracking-0.1em text-[#37517e] ml-1">Proposal
                                    (Khusus Penelitian) <span class="text-red-500">*Maks 5MB</span></label>
                                ...
                                @if ($profile->proposal_file_path)
                                    <p class="text-xs text-emerald-600 font-bold ml-1 mt-2">
                                        <i class="bi bi-check-circle-fill mr-1"></i> File Proposal sudah tersimpan.
                                    </p>
                                @endif
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                {{-- Card Keamanan --}}
                <div
                    class="bg-[#37517e] rounded-[2.5rem] p-8 text-white shadow-2xl shadow-blue-900/30 relative overflow-hidden group">
                    <div class="relative z-10 text-center">
                        <div
                            class="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-white/20">
                ...
                <button type="submit"
                    class="w-full bg-blue-600 text-white p-5 rounded-2rem font-black uppercase tracking-widest text-xs hover:bg-blue-700 hover:scale-[1.02] active:scale-95 shadow-xl shadow-blue-200 transition-all duration-300 flex items-center justify-center gap-3">
