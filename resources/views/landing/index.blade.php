...
@section('content')
    ...
    <section class="relative w-full min-h-130 lg:min-h-145 flex flex-col justify-between overflow-hidden" id="home">
        ...
        {{-- ============================================================ --}}
        {{-- STATS BAR — bawah, konsisten dengan versi sebelumnya          --}}
        {{-- ============================================================ --}}
            ...
            <div class="max-w-6xl mx-auto px-6 py-4">
                <div class="grid grid-cols-3 divide-x divide-white/20">
                    ...
                    <div class="text-center px-4">
                        <p class="text-white font-extrabold text-xl md:text-2xl tabular-nums">100+</p>
                        <p class="text-blue-200/80 text-[9px] md:text-[10px] font-semibold uppercase tracking-wider mt-0.5">
                            Peserta Aktif</p>
                    </div>

                    <div class="text-center px-4">
                        <p class="text-white font-extrabold text-xl md:text-2xl tabular-nums">15+</p>
                        <p class="text-blue-200/80 text-[9px] md:text-[10px] font-semibold uppercase tracking-wider mt-0.5">
                            Divisi Tersedia</p>
                    </div>

                    <div class="text-center px-4">
                        <p class="text-white font-extrabold text-xl md:text-2xl tabular-nums">500+</p>
                        <p class="text-blue-200/80 text-[9px] md:text-[10px] font-semibold uppercase tracking-wider mt-0.5">
                            Alumni Magang</p>
                    </div>
