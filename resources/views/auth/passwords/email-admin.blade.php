...
<head>
    ...
    <title>Lupa Password Admin - SINAKERTRANS</title>
...
<body class="bg-white min-h-screen flex">
    ...
    <div class="hidden lg:flex flex-col justify-between w-105 shrink-0 px-12 py-12 border-r border-gray-100">
        ...
        <div>
            ...
            <div class="w-16 h-16 bg-amber-50 rounded-2xl flex items-center justify-center mb-6"
                ...
                <i class="bi bi-person-badge text-amber-500 text-3xl"></i>
            </div>
            ...
            <p class="text-sm text-gray-400 leading-relaxed mb-8">
                Masukkan email admin dinas Anda yang terdaftar. Kami akan mengirimkan link untuk mereset password Anda.
            </p>

            {{-- Step hints --}}
            <div class="space-y-4">
                @foreach ([['icon' => 'bi-envelope', 'color' => 'blue', 'title' => 'Masukkan Email Admin', 'desc' => 'Email resmi kedinasan Anda'], ['icon' => 'bi-send', 'color' => 'indigo', 'title' => 'Cek Inbox', 'desc' => 'Link reset dikirim dalam 1-2 menit'], ['icon' => 'bi-shield-lock', 'color' => 'emerald', 'title' => 'Reset Password', 'desc' => 'Buat password baru untuk akses admin']] as $step)
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div class="w-full max-w-sm">
            ...
            {{-- Heading --}}
            <div class="mb-8">
                <h2 class="text-2xl font-extrabold text-gray-900 mb-1">Reset Password Admin</h2>
                <p class="text-sm text-gray-400">
                    Kami akan mengirim link reset ke email admin Anda.
                </p>
            </div>
            ...
            {{-- FORM (Perhatikan action-nya sudah mengarah ke rute admin) --}}
