        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <span class="text-xl md:text-2xl font-bold text-blue-600 tracking-wide">SINAKERTRANS</span>
                </div>

                <div class="hidden md:flex items-center gap-6">
                    {{-- CEK 1: APAKAH YANG LOGIN ITU ADMIN? --}}
                    @if (Auth::guard('web')->check())
                        <span class="text-sm text-gray-600 font-bold">Halo, <strong>Admin</strong></span>
            ...
            <ul class="flex gap-8 items-center font-bold text-sm uppercase tracking-wide text-[#37517e]">
                <li>
            ...
            <li>
                ...
                {{-- Profile Dropdown --}}
        <div class="relative group ml-4"> {{-- Tambahkan ml-4 untuk jarak dari menu --}}
            ...
            <div class="absolute right-0 hidden group-hover:block pt-2 w-44 z-50">
                <div class="bg-white border border-gray-100 rounded-xl shadow-xl py-1.5 overflow-hidden">
                    ...
                    @else
                         <a href="{{ route('login') }}"
                            class="text-2xl bg-white text-blue-600 px-5 py-2 rounded-full font-bold hover:bg-blue-700 hover:text-white transition">
                            Masuk
                        </a>
