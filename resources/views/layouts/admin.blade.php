    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-slate-800 text-white shrink-0 hidden md:flex flex-col">
            ...
            <a href="{{ route('admin.profile') }}" 
                    class="flex items-center px-4 py-2 text-sm font-medium rounded-md transition-colors
                    {{ request()->routeIs('admin.profile') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white' }}">
                    <i class="bi bi-person-circle mr-3"></i> Profil Saya
            </a>
            {{-- /TAB AKUN --}}
