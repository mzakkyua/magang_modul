            ...
            <div class="bg-white rounded-lg shadow p-6 text-center border-t-4 border-blue-600">
                ...
                <div class="mb-4 relative group inline-block">
                    ...
                    <div id="initialPlaceholder"
                        class="{{ $user->profile_photo_path ? 'hidden' : '' }} h-32 w-32 rounded-full bg-blue-100 mx-auto flex items-center justify-center text-blue-600 text-5xl font-bold border-4 border-white shadow-sm">
                    ...
                    <form action="{{ route('admin.profile.update') }}" method="POST" id="profileForm"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-blue-600 toggle-password"
                                        data-target="new_password"><i class="bi bi-eye-slash"></i></button>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-blue-600 toggle-password"
                                        data-target="new_password_confirmation"><i class="bi bi-eye-slash"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end">
                            <button type="button" id="btnSaveProfile" disabled
                                class="bg-blue-600 text-white font-bold py-2 px-6 rounded shadow transition opacity-50 cursor-not-allowed hover:bg-blue-600 flex items-center">
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    @foreach ($sessions as $session)
                                        <div
                                            class="flex items-center justify-between p-3 border rounded-lg {{ $session->is_current_device ? 'border-blue-200 bg-blue-50' : 'border-gray-200' }}">
                                            <div class="flex items-center">
                                                <div
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500">
                                                        ...
                                                        @if ($session->is_current_device)
                                                            <span class="text-green-600 font-bold">Perangkat Ini</span>
                                                        @else
